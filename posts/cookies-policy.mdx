...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to Vocab Builder.
...
- __Website__ refers to Vocab Builder, accessible from [https://vocab-builder.app](https://vocab-builder.app)
